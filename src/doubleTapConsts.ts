...
// Tile action delays - shorter for unrevealed tiles for better responsiveness
...
export const REVEALED_TILE_ACTION_DELAY_MS = 150; // milliseconds - enough time to detect double-tap on revealed tiles
