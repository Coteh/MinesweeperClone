...
describe('Dialog Stack System', () => {
    ...
    it('should stack dialogs (LIFO behavior)', () => {
        ...
        cy.get('[data-dialog-id]').invoke('attr', 'data-dialog-id').then((firstId) => {
            ...
            cy.get('[data-dialog-id]').should('have.length', 1);
            cy.get('[data-dialog-id]').invoke('attr', 'data-dialog-id').should('not.equal', firstId);
        });
    });
    ...
    it('should restore previous dialog when current is closed', () => {
        ...
        cy.get('[data-dialog-id]').invoke('attr', 'data-dialog-id').then((firstId) => {
            ...
            cy.get('[data-dialog-id]').invoke('attr', 'data-dialog-id').then((secondId) => {
